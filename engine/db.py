...
def _log_audit(cursor: sqlite3.Cursor, action: str, ipc_section: str,
...
def insert_mapping(ipc_section: str, bns_section: str, notes: str = "",
                  source: str = "user", category: str = "User Added",
...
def update_mapping(ipc_section: str, bns_section: str, notes: str = "",
                   source: str = "user", category: str = "User Added",
                   actor: str = "system") -> bool:
    ...
    try:
        ...
        cursor.execute(
            """
            UPDATE mappings
            SET bns_section = ?, notes = ?, source = ?, category = ?
            WHERE ipc_section = ?
            """,
            (bns_section, notes, source, category, ipc_section),
        )
        new_value = {
            "ipc_section": ipc_section,
            "bns_section": bns_section,
...
def upsert_mapping(ipc_section: str, bns_section: str, notes: str = "",
                   source: str = "user", category: str = "User Added",
                   actor: str = "system") -> bool:
